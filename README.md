...
![badge](https://img.shields.io/endpoint?color=neon&url=https%3A%2F%2Ftg.sumanjay.workers.dev%2Fdpy_self)

![badge](https://img.shields.io/pypi/v/discord.py-self.svg)

![badge](https://img.shields.io/pypi/pyversions/discord.py.svg)

![badge](https://img.shields.io/pypi/dm/discord.py-self.svg)
...
Check out our [docs](https://discordpy-self.readthedocs.io/en/latest/index.html) for more.

Credits:
--------
- [Rapptz](https://github.com/Rapptz) – Creator of the original library.
- [arandomnewaccount](https://www.reddit.com/user/obviouslymymain123/) – Helped in early development.
...
A [virtual environment](https://docs.python.org/3/library/venv.html) is highly recommended, especially on Linux systems.
...
Optional Packages
###~~~~~
- [PyNaCl](https://pypi.org/project/PyNaCl/) – Required for voice support
...
See the [renamed branch](https://github.com/dolfies/discord.py-self/blob/renamed/README.rst) for more.
